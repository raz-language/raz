...
# Build the Raz-written compiler with the native bootstrap seed.  The bug this
...
if(NOT EXISTS "${stage1_executable}")
  message(FATAL_ERROR "Generated Raz compiler is missing: ${stage1_executable}")
endif()
...
execute_process(
  COMMAND "${stage1_executable}" "mutable-parameter.txt" "mutable-parameter.fir"
...
if(NOT emitted_ir MATCHES "call void @raz_rt_stage1_arena_set")
...
message(STATUS "self-host mutable-parameter lowering: PASS")
