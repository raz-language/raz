...
if(WIN32)
  set(runtime_exe "${WORK_ROOT}/target/debug/bin/application_stack_runtime_fixture.exe")
else()
  set(runtime_exe "${WORK_ROOT}/target/debug/bin/application_stack_runtime_fixture")
endif()
