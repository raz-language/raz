...
if(WIN32)
  set(runtime_exe "${WORK_ROOT}/target/debug/bin/collection_ergonomics_runtime_fixture.exe")
else()
  set(runtime_exe "${WORK_ROOT}/target/debug/bin/collection_ergonomics_runtime_fixture")
endif()
