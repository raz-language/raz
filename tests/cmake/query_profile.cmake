...
if(WIN32)
  set(seed "${WORK_ROOT}/compiler/target/debug/bin/raz-compiler.exe")
else()
  set(seed "${WORK_ROOT}/compiler/target/debug/bin/raz-compiler")
endif()
if(NOT EXISTS "${seed}")
...
set(profile_path "${WORK_ROOT}/target/profile/compiler-query-profile.txt")
