...
execute_process(COMMAND "${RAZ_EXE}" build "${consumer}" --force
...
set(dmi "${WORK_ROOT}/interface-dependency/target/debug/bin/modules/lib.dmi")
if(NOT EXISTS "${dmi}")
...
endforeach()
execute_process(COMMAND "${RAZ_EXE}" build "${consumer}" --verbose
...
execute_process(COMMAND "${RAZ_EXE}" check "${consumer}" --force
