...
CHECKS = [
    ...
    'check-wasm-writer-growth.py',
    'check-web-wasm-function-compaction.py',
    'check-web-js-host-pruning.py',
    'check-web-runtime-pruning.py',
    'check-web-production-hardening.py',
    'check-web-backend-closure.py',
    'check-web-release-artifact-contract.py',
    'check-web-routing-ownership.py',
    'check-bootstrap-modular-web-qualification.py',
    'check-stage0-seed-source-layout.py',
    'check-stage0-web-driver-stubs.py',
...
def main() -> int:
    ...
    harness = ROOT / 'tests/python/test-backend-differential-wasm-suite.py'
