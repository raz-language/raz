...
checks = {
    ...
    "Raz HIR maps dependency import prefixes": (root / "compiler/src/hir/core/symbols.rz", "i64 dependency_package = hir_find_package_dependency("),
    "Raz HIR substitutes dependency package roots in imports": (root / "compiler/src/hir/core/symbols.rz", "target_hash = dependency_package"),
    "Raz HIR substitutes dependency package roots in qualified names": (root / "compiler/src/hir/generics/instantiate.rz", "qualified_package = dependency_package"),
    "Raz project emits package provenance": (root / "compiler/src/driver/project.rz", 'string package_prefix = "__raz_package "'),
    "Raz project emits module provenance": (root / "compiler/src/driver/project.rz", 'string module_marker = "__raz_module;'),
    ...
    "Raz workspace recognizes official library packages": (root / "compiler/src/driver/package.rz", 'string expected = "library"'),
