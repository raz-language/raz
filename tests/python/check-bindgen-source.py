...
source=(ROOT/'compiler/src/raz_driver/src/driver/bindgen.rz').read_text(encoding='utf-8')
...
checks={
 'bindgen production module':'src/raz_driver/src/driver/bindgen.rz' in order,
