...
checks = {
    ...
    'normal compilation announces every dependency package': 'cli_print_dependency_compile_statuses(cli_command, &input, cli_manifest_path, cli_manifest_length);' in (ROOT / 'compiler/src/main.rz').read_text(encoding='utf-8'),
