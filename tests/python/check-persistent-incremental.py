...
checks = {
    ...
    'HIR exports module fingerprints beyond builder lifetime': 'incremental_module_fingerprint_count' in model and 'builder.queries.query_module_fingerprint_count' in comptime,
