...
fixture = (ROOT / 'tests/examples/web/effects-lifecycle/src/main.rz').read_text()
checks = {
...
if failed:
    for name in failed: print(f'web-effects: FAIL: {name}')
    raise SystemExit(1)
print(f'web-effects: PASS ({len(checks)} checks)')
