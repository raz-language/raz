...
required=[
 'compiler/src/raz_mir/src/mir/core/model.rz','compiler/src/raz_mir/src/mir/core/builder.rz','compiler/src/raz_mir/src/mir/cleanup_index.rz','compiler/src/raz_mir/src/mir/lowering.rz',
 'compiler/src/raz_mir/src/mir/analysis/cfg.rz','compiler/src/raz_mir/src/mir/verify/verifier.rz',
 'compiler/src/raz_mir_opt/src/mir_opt/transform/pipeline.rz','compiler/src/raz_mir/src/mir/interpreter.rz']
problems=[]
for rel in required:
 p=root/rel
