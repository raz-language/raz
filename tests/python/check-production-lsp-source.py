...
checks = {
    "production CLI owns lsp command": "i64 c_lsp[3]" in CLI and "return 42;" in CLI,
    ...
    "LSP uses native stdio boundary": "extern fn raz_rt_stdio_read" in LSP and "Content-Length" not in LSP,
    ...
    "LSP advertises semantic capabilities": "i64 result[778]" in LSP and all(handler in LSP for handler in ("lsp_send_hover(", "lsp_send_definition(", "lsp_send_references(", "lsp_send_rename(", "lsp_send_semantic_tokens(", "lsp_send_inlay_hints(", "lsp_send_workspace_symbols(")),
