...
require('compiler/src/hir/core/model.rz', ['block_generic_substitution_counts', 'block_generic_substitution_type_structures', 'block_generic_substitution_types'])
require('compiler/src/hir/semantic/statements.rz', ['builder.generic_substitution_count', 'builder.module.block_generic_substitution_counts', 'saved_generic_substitution_count'])
require('compiler/src/backend/forge/writer.rz', ['Built-in `string` carries immutable C-string address bits', 'if (type_kind == 13)', 'writer_i64(out)'])
require('compiler/src/backend/forge/native_support.rz', ['fn forge_native_type(i64 type_kind)', 'type_kind == 12', 'type_kind == 14'])
require('compiler/src/backend/forge/native_functions.rz', ["Raz's built-in string value is", 'forge_native_append_operation(current_block, result, opcode, 5)'])
...
require('compiler/src/backend/forge/native_types.rz', ['fn forge_native_scalar_mir_local_type', 'MIR lowering may synthesize frame slots', 'forge_native_scalar_mir_local_type(hir, mir, function_index, local_slot)'])
