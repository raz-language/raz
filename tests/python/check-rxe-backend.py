...
for name in required:
    p=root/'compiler/src/raz_codegen_rxe/src/rxe'/name
    assert p.is_file(), f'missing {p}'
    assert f'src/raz_codegen_rxe/src/rxe/{name}' in order, f'{name} absent from semantic compiler source graph'
...
lowering=(root/'compiler/src/raz_codegen_rxe/src/rxe/lowering.rz').read_text()
...
dataflow=(root/'compiler/src/raz_codegen_rxe/src/rxe/dataflow.rz').read_text()
...
registers=(root/'compiler/src/raz_codegen_rxe/src/rxe/registers.rz').read_text()
...
optimize=(root/'compiler/src/raz_codegen_rxe/src/rxe/optimize.rz').read_text()
...
model=(root/'compiler/src/raz_codegen_rxe/src/rxe/model.rz').read_text()
...
verify=(root/'compiler/src/raz_codegen_rxe/src/rxe/verify.rz').read_text()
...
blocks=(root/'compiler/src/raz_codegen_rxe/src/rxe/blocks.rz').read_text()
assert 'rxe_build_blocks' in blocks and 'block_successor0' in blocks and 'block_successor1' in blocks
disasm=(root/'compiler/src/raz_codegen_rxe/src/rxe/disasm.rz').read_text()
