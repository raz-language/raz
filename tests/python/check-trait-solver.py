...
checks = {
    ROOT / 'compiler/src/raz_hir/src/hir/core/model.rz': [
        'query_active_kinds',
        'query_active_a',
        'query_active_count',
    ],
    ROOT / 'compiler/src/raz_hir/src/hir/core/builder.rz': [
    ...
    ROOT / 'compiler/src/raz_hir/src/hir/query/engine.rz': [
    ...
    ROOT / 'compiler/src/raz_hir/src/hir/generics/type_instantiation.rz': [
    ...
    ROOT / 'compiler/src/raz_hir/src/hir/traits/solver.rz': [
