...
def main() -> int:
    ...
    store = work / "home" / "store" / checksum
    store.mkdir(parents=True)
    (project / "raz.toml").write_text(
        '[package]\nname = "app"\nversion = "0.1.0"\nkind = "executable"\n\n'
        '[dependencies]\nwidget = "registry:widget@^1.0.0"\n',
        encoding="utf-8",
    )
    (store / "raz.toml").write_text(
        '[package]\nname = "widget"\nversion = "1.1.0"\nkind = "library"\n\n[dependencies]\n',
        encoding="utf-8",
    )
    (project / "raz.lock").write_text(
        '# Generated by Raz. Do not edit manually.\nversion = 1\n\n'
        '[[package]]\nname = "app"\nversion = "0.1.0"\nkind = "executable"\npath = "."\n\n'
        '[[package]]\nname = "widget"\nversion = "1.1.0"\nkind = "library"\n'
        f'path = "registry:{checksum}"\nsource = "registry"\nchecksum = "{checksum}"\n',
        encoding="utf-8",
    )
