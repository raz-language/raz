...
CHECKS = (
    ...
    "check-hir-resolution-performance.py",
    ...
    "check-production-lsp-source.py",
    "check-bindgen-source.py",
    "check-c-header-source.py",
    "check-component-sync-tools.py",
    "check-project-native-output.py",
    "check-qualified-types-and-diagnostics.py",
    "check-stdlib-format.py",
    "check-stdlib-ergonomics.py",
    "check-forge-package.py",
    "check-llvm-backend-parity.py",
    "check-llvm-production-backend.py",
    "check-platform-expansion.py",
