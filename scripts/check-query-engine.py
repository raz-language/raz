...
checks = {
    ...
    'query storage is initialized and destroyed centrally': all(x in builder for x in [
        'query_cache_kinds = raz_rt_stage1_arena_create',
        'query_dependency_parent_kinds = raz_rt_stage1_arena_create',
        'raz_rt_stage1_arena_destroy(out.query_cache_kinds)',
        'raz_rt_stage1_arena_destroy(out.query_dependency_parent_kinds)']),
