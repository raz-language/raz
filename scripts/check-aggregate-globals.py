...
required = {
    ...
    "llvm": ["llvm_emit_global_lifecycle", "llvm_emit_static_aggregate_create", "llvm_emit_static_aggregate_destroy", "create_call", "destroy_call"],
...
if "src/backend/llvm/globals_codegen.rz" not in order:
    raise SystemExit("aggregate-globals: FAIL missing llvm globals module from source order")
example = (root / "examples/backends/aggregate_globals.rz").read_text(encoding="utf-8")
