...
checks = {
    ...
    'host import count frozen': 'return 24;' in writer,
...
if missing:
    raise SystemExit('wasm-abi-freeze: FAIL: ' + ', '.join(missing))
print('wasm-abi-freeze: PASS (Raz WebAssembly ABI v1 implementation/layout contract)')
