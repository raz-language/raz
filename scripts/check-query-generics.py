...
checks = {
    ...
    'canonical identity storage is centrally managed': all(x in builder for x in [
        'query_monomorph_entity_kinds = raz_rt_stage1_arena_create',
        'query_monomorph_argument_structures = raz_rt_stage1_arena_create',
        'raz_rt_stage1_arena_destroy(out.query_monomorph_entity_kinds)',
        'raz_rt_stage1_arena_destroy(out.query_monomorph_argument_structures)']),
